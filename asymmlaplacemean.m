function MU = asymmlaplacemean(m,b1,b2)

% function MU = asymmlaplacemean(m,b1,b2) 
%
%   example call: % EXACTLY EQUALS LAPLACE PDF WHEN k EQUALS 0.0
%                   MU = asymmlaplacemean(0,1/2,2)
%                    
% mean of asymmetric laplace distribution
%
...
% INPUT CHECKING
if b1 <= 0, error('asymmlaplacemean: WARNING! PARAMETER b1 MUST BE LARGER THAN 0'); end
if b2 <= 0, error('asymmlaplacemean: WARNING! PARAMETER b2 MUST BE LARGER THAN 0'); end
